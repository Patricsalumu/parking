...
@section('content')
<div class="mb-3">
  <h3>Véhicule: {{ $vehicule->plaque }}</h3>
  <div>{{ $vehicule->marque ?? '' }} — {{ $vehicule->compagnie ?? '' }}</div>
</div>
...
<div class="row">
  <div class="col-md-6">
    <div class="card p-3 mb-3">
      <h6>Résumé</h6>
      @php
        $entries = $vehicule->entrees ?? collect();
        $totalBilled = 0; $totalPaid = 0; $countEntries = $entries->count();
  ...
  <div class="col-md-6">
    <div class="card p-3 mb-3">
      ...
      <table class="table table-sm">
        <thead><tr><th>#</th><th>Numero</th><th>Entrée</th><th>Sortie</th><th>Facture</th><th>Total</th><th>Payé</th></tr></thead>
        <tbody>
          @foreach($vehicule->entrees as $en)
    ...
    <div class="card p-3">
      <h6>Facturations</h6>
      <table class="table table-sm">
        <thead><tr><th>#</th><th>Numero</th><th>Entrée</th><th>Duree</th><th>Total</th><th>Payé</th><th>Reste</th></tr></thead>
        <tbody>
