...
<div style="font-family: Arial, Helvetica, sans-serif; max-width:900px; margin:0 auto;">
  ...
  <h3 style="margin:4px 0 12px">Clients Report</h3>
  ...
  <table style="width:100%; border-collapse:collapse; font-size:12px;">
    <thead>
      <tr style="background:#f0f0f0; text-align:left">
        ...
        <th style="padding:6px; border:1px solid #ddd">Téléphone</th>
    ...
    <tbody>
      @foreach($rows as $r)
        ...
        <tr>
          ...
          <td style="padding:6px; border:1px solid #ddd">{{ $r->nom }}</td>
          <td style="padding:6px; border:1px solid #ddd">{{ $r->telephone }}</td>
